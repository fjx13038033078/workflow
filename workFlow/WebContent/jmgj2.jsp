...
<body>
    ...
    <textarea id="mydata" name="jcontext" rows="50" cols="40" style="visibility:hidden; height: 22px; width: 1761px">
 	...
 	${workFlow.wfJson }
 	  ...
 	  <!-- <div>保存模板到模板库<input class= "login-button" type="submit" value="保存到我的模板库"  style="width: 130px; height: 37px">
 	  下载模板到本地:<input class= "login-button" type="button" value="保存模板到本地" onclick="demo.saveas()" style="width: 130px; height: 37px"></input></div> -->
 	  <div><input  type="file" id="file" style="width: 2px "/></div>
 	 
<!--  	  读取模板文件（双击）：<input type="button" class= "login-button" value="读取本地模板" onclick="demo.AsText();" style="width: 144px; height: 34px"/> -->
 	</form>  
