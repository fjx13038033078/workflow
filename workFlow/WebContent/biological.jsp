...
<div id="templatemo_site_title_bar_wrapper">
	<div id="templatemo_site_title_bar">
        ...
        <ul id="templatemo_menu">
            ...
            <li><a href="myworkflow.jsp"><span></span>我的工作流</a></li>
            <li><a href="http://nscc.tbocii.tk:8000/#/"><span></span>返回社区</a></li>
            <li><a href="#"><span></span>用户AAA</a></li>
        </ul>
...
<div id="templatemo_content">
    <div class="section_w940" >
                <h3>Open babel-Autodock vina模板</h3>
              	<img src="images/babel.jpg" class="img_fl img_border"/>
                <h4>使用了软件Open babel和Autodock Vina连用</h4>
                <p>说明：Open Babel允许任何人从分子建模、化学、固态材料、生物化学或相关领域中搜索、转换、分析或存储数据，而Autodock vina主要用于生物领域的分子对接，该工作流提供了开源软件open babel和autodock vina的连用功能。</p>
